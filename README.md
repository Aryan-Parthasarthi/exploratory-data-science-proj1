## Exploratory Data Analysis 1st project on plotting
...
You may find it useful to convert the Date and Time variables to Date/Time classes in R using the strptime()  and color{red} as.Date() functions.
